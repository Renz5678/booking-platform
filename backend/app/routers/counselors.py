...
from app.schemas.counselor import CounselorProfilePublicResponse, CounselorProfilePrivateResponse, CounselorProfileUpdate
...
async def update_my_counselor_profile(
    ...
    updated_profile = await counselor_service.update_counselor_profile(db, counselor, update_data)
